      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.form}>
          <View style={styles.inputGroup}>
            <Text style={styles.label}>Assunto da sugestão</Text>
            <TextInput
              style={styles.input}
              placeholder="Ex: Melhorias no atendimento, novos serviços..."
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              placeholder="Descreva sua sugestão, como ela pode ser implementada e quais benefícios traria..."
              placeholderTextColor="#9CA3AF"
              multiline
              numberOfLines={6}
            />
