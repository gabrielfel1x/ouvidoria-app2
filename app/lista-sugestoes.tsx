...
export default function ListaSugestoesScreen() {
  ...
  const handleDeletePress = (sugestao: Ocorrencia) => {
    setOcorrenciaToDelete(sugestao);
      ...
      <View style={styles.header}>
        <View style={styles.headerTop}>
          ...
          <View style={styles.titleContainer}>
            <Text style={styles.headerTitle}>Minhas Sugestões</Text>
          </View>
        ...
        <View style={styles.headerContent}>
          <Text style={styles.headerSubtitle}>
            {sugestoes.length} {sugestoes.length === 1 ? 'sugestão enviada' : 'sugestões enviadas'}
          </Text>
        </View>
      </View>
                  ...
                  <View style={styles.cardHeaderInfo}>
                    <View style={styles.headerTags}>
                      <View style={styles.setorTag}>
                        ...
                        <Text style={styles.setorText}>{sugestao.setor}</Text>
                      </View>
                ...
                <View style={styles.cardBody}>
                  ...
                  <View style={styles.cardFooter}>
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.dataText}>{formatarData(sugestao.data)}</Text>
                    </View>
                    
                    <View style={styles.infoRow}>
                      <Ionicons name="key-outline" size={14} color="#6B7280" />
                      <Text style={styles.protocoloText}>{sugestao.numero_protocolo}</Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.cardActions}>
                    <TouchableOpacity 
                      ...
                      onPress={(e) => {
                        ...
                        console.log('Editar sugestão:', sugestao.id);
                      }}
                    >
        ...
        {sugestoes.length === 0 && (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptySubtitle}>
              Suas sugestões enviadas aparecerão aqui
            </Text>
          </View>
        )}
      </ScrollView>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              ...
              <Text style={styles.modalTitle}>Excluir Sugestão?</Text>
              <Text style={styles.modalSubtitle}>
                Esta ação não pode ser desfeita. A sugestão será permanentemente removida.
              </Text>
            </View>
